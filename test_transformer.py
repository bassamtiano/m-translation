...
with open("source.txt") as fps:
    sentences_source = fps.readlines()

with open("fixed.txt") as fpf:
    sentences_fixed = fpf.readlines()
...
# with open('source.json') as source_json_file:
